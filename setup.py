...
name = 'tkitBentomlFrameworksExpand'  # 修改包名字-
version = '0.0.0.2' + str(time.time())[:8]
description = 'Terry toolkit tkit-bentoml-tkitBentomlFrameworksExpand-expand,'
author = 'Terry Chan'
...
setup(
    ...
    # ],
    packages=['tkitBentomlFrameworksExpand'],  # 扫描的目录
